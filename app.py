...
def register():
    ...
    if request.method == "POST":
        ...
        query = "INSERT INTO users (user_name, email, password_hash, user_type, latitude, longitude) VALUES (%s, %s, %s, %s, %s, %s)"
        data =  (user_name, email, str(generate_password_hash(password)), user_type, Decimal("0.0"), Decimal("0.0"))
        cur.execute(query, data)
